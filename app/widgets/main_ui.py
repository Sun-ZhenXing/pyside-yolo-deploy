...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imageLabel = QLabel(self.gridLayoutWidget)
        self.imageLabel.setObjectName("imageLabel")
        self.imageLabel.setMinimumSize(QSize(400, 0))
        self.imageLabel.setStyleSheet("background-color: #090909")
        self.imageLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.gridLayout_1.addWidget(self.imageLabel, 0, 0, 1, 1)
        ...
        self.confLabel = QLabel(self.groupBox)
        self.confLabel.setObjectName("confLabel")

        self.gridLayout_4.addWidget(self.confLabel, 1, 0, 1, 1)
